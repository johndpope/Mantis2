...
public class JsonValue implements Iterable<JsonValue> {
	...
	/**
	 * Returns the child at the specified index. This requires walking the
	 * linked list to the specified entry, see {@link JsonValue} for how to
	 * iterate efficiently.
	 * 
	 * @return May be null.
	 */
	...
	/**
	 * Removes the child with the specified index. This requires walking the
	 * linked list to the specified entry, see {@link JsonValue} for how to
	 * iterate efficiently.
	 * 
	 * @return May be null.
	...
	/**
	 * @deprecated Use the size property instead. Returns this number of
	 *             children in the array or object.
	 */
	@Deprecated
	public int size() {
		return size;
	...
	/**
	 * @param stringValue
	 *            May be null if the string representation is the string value
	 *            of the double (eg, no leading zeros).
	 */
	 ...
	 * @param stringValue
	 *            May be null if the string representation is the string value
	 *            of the long (eg, no leading zeros).
	 */
	...
	/**
	 * Returns a human readable string representing the path from the root of
	 * the JSON object graph to this value.
	 */
	public String trace() {
		if (parent == null) {
			if (type == ValueType.array)
