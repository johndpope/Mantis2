...
public enum Scaling {
	...
	fillY,
	/**
	 * Scales the source to fill the target. This may cause the source to not
	 * keep the same aspect ratio.
	 */
	stretch,
	/**
	 * Scales the source to fill the target in the x direction, without changing
	 * the y direction. This may cause the source to not keep the same aspect
	 * ratio.
	 */
	stretchX,
	/**
	 * Scales the source to fill the target in the y direction, without changing
	 * the x direction. This may cause the source to not keep the same aspect
	 * ratio.
	 */
	stretchY,
	...
	/**
	 * Returns the size of the source scaled to the target. Note the same
	 * Vector2 instance is always returned and should never be cached.
	 */
