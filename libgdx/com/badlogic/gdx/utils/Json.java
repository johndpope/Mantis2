...
public class Json {
	 ...
	 * throw a {@link SerializationException}. Default is false.
	 */
	...
	/**
	 * Sets a tag to use instead of the fully qualifier class name. This can
	...
	/**
	 * When true, field values that are identical to a newly constructed
	 * instance are not written. Default is true.
	 */
	 ...
	 * known, the class for each element in the collection does not need to be
	 * written unless different from the element type.
	 */
	...
	/**
	 * Writes the value as a field on the current JSON object, writing the class
	 * of the object if it differs from the specified known type. The specified
	 * element type is used as the default type for collections.
	 * 
	 * @param value
	 *            May be null.
	 * @param knownType
	...
	/**
	 * Writes the value, writing the class of the object if it differs from the
	 * specified known type. The specified element type is used as the default
	...
	/**
	 * @param object
	 *            May be null if the field is static.
	 * @param elementType
	 *            May be null if the type is unknown.
	 */
