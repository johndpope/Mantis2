...
public class UBJsonWriter implements Closeable {
	...
	/**
	 * Appends a {@code char} value to the stream. Because, in Java, a
	 * {@code char} is 16 bytes, this corresponds to the {@code int16} value
	 * type in the UBJSON specification.
	 * 
	 * @return this writer, for chaining
	 */
	...
	/**
	 * Appends an optimized {@code byte array} value to the stream. As an
	 * optimized array, the {@code int8} value type marker and element count are
	...
	/**
	 * Appends an optimized {@code short array} value to the stream. As an
	 * optimized array, the {@code int16} value type marker and element count
	 * are encoded once at the array marker instead of repeating the type marker
	 * for each element.
	 * 
	 * @return this writer, for chaining
	 */
	...
	/**
	 * Appends an optimized {@code int array} value to the stream. As an
	 * optimized array, the {@code int32} value type marker and element count
	 * are encoded once at the array marker instead of repeating the type marker
	 * for each element.
	 * 
	 * @return this writer, for chaining
	...
	/**
	 * Appends an optimized {@code long array} value to the stream. As an
	 * optimized array, the {@code int64} value type marker and element count
	 * are encoded once at the array marker instead of repeating the type marker
	 * for each element.
	 * 
	 * @return this writer, for chaining
	...
	/**
	 * Appends an optimized {@code float array} value to the stream. As an
	 * optimized array, the {@code float32} value type marker and element count
	 * are encoded once at the array marker instead of repeating the type marker
	 * for each element.
	 * 
	 * @return this writer, for chaining
	 ...
	 * optimized array, the {@code float64} value type marker and element count
	 * are encoded once at the array marker instead of repeating the type marker
	 * for each element. element count are encoded once at the array marker
	...
	/**
	 * Appends an optimized {@code char array} value to the stream. As an
	 * optimized array, the {@code int16} value type marker and element count
	 * are encoded once at the array marker instead of repeating the type marker
	 * for each element.
	 * 
	 ...
	 * optimized array, the {@code String} value type marker and element count
	 * are encoded once at the array marker instead of repeating the type marker
	 * for each element.
	 * 
	 * @return this writer, for chaining
	...
	/**
	 * Flushes the underlying stream. This forces any buffered output bytes to
