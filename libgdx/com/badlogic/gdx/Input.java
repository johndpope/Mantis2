...
public interface Input {
	...
	static public class Keys {
		...
		/**
		 * @return a human readable representation of the keycode. The returned
		 *         value can be used in {@link Input.Keys#valueOf(String)}
		 */
		public static String toString(int keycode) {
			...
			case F12:
				return "F12";
			// BUTTON_CIRCLE unhandled, as it conflicts with the more likely to
			// be pressed F12
			default:
				// key name not found
				return null;
		...
		/**
		 * @param keyname
		 *            the keyname returned by the {@link Keys#toString(int)}
		 *            method
	...
	/**
	 * @return The x coordinate of the last touch on touch screen devices and
	 *         the current mouse position on desktop for the first pointer in
	 *         screen coordinates. The screen origin is the top left corner.
	 */
	public int getX();
	...
	/**
	 * @return The y coordinate of the last touch on touch screen devices and
	 *         the current mouse position on desktop for the first pointer in
	 *         screen coordinates. The screen origin is the top left corner.
	 */
	public int getY();
	...
	/**
	 * Whether a given button is pressed or not. Button constants can be found
	 * in {@link Buttons}. On Android only the Button#LEFT constant is
	 * meaningful before version 4.0.
	 * 
	 * @param button
	 *            the button to check.
	 ...
	 * permission <code> <uses-permission android:name=
	 * "android.permission.VIBRATE" /></code> in your manifest file in order for
	 * this to work.
	 * 
	 * @param milliseconds
	 ...
	 * Android and the {@link Peripheral#HardwareKeyboard} this returns the
	 * whether the keyboard is currently slid out or not.
	 * 
	 * @param peripheral
	 *            the {@link Peripheral}
	...
	/**
	 * @return the rotation of the device with respect to its native
	 *         orientation.
	 */
	 ...
	 * window and hide the mouse cursor. X and y coordinates are still reported
	 * as if the mouse was not catched.
	 * 
	 * @param catched
	...
	/**
	 * Only viable on the desktop. Will set the mouse cursor location to the
	 * given window coordinates (origin top-left corner).
	 * 
	 * @param x
	 *            the x-position
	 * @param y
