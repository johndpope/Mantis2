...
public interface Sound extends Disposable {
	/**
	 * Plays the sound. If the sound is already playing, it will be played
	 * again, concurrently.
	 * 
	 ...
	 *            the volume in the range [0,1]
	 * @param pitch
	 *            the pitch multiplier, 1 == default, >1 == faster, <1 ==
	...
	/**
	 * Plays the sound, looping. If the sound is already playing, it will be
	...
	/**
	 * Plays the sound, looping. If the sound is already playing, it will be
	 * played again, concurrently. You need to stop the sound via a call to
	...
	/**
	 * Stops the sound instance with the given id as returned by {@link #play()}
	 * or {@link #play(float)}. If the sound is no longer playing, this has no
	 * effect.
	 * 
	 * @param soundId
	 *            the sound id
	 ...
	 * {@link #play()} or {@link #play(float)}. If the sound is not paused, this
	 * has no effect.
	 * 
	 * @param soundId
	 *            the sound id
	...
	/**
	 * Sets the sound instance with the given id to be looping. If the sound is
	 * no longer playing this has no effect.s
	 * 
	 * @param soundId
	 *            the sound id
	 * @param looping
