...
public abstract class GLFrameBuffer<T extends GLTexture> implements Disposable {
	 ...
	 *            spec, only RGB565, RGBA4444 and RGB5_A1 are color-renderable
	 * @param width
	...
	/**
	 * Override this method in a derived class to set up the backing texture as
	 * you like.
	 */
	protected abstract T createColorTexture();

	/**
	 * Override this method in a derived class to dispose the backing texture as
	 * you like.
	 */
	protected abstract void disposeColorTexture(T colorTexture);

	/**
	 * Override this method in a derived class to attach the backing texture to
	...
	private void build() {
		...
		if (result == GL20.GL_FRAMEBUFFER_UNSUPPORTED && hasDepth && hasStencil
			...
			gl.glRenderbufferStorage(GL20.GL_RENDERBUFFER, GL_DEPTH24_STENCIL8_OES, colorTexture.getWidth(),
					colorTexture.getHeight());
			gl.glBindRenderbuffer(GL20.GL_RENDERBUFFER, 0);
	...
	/**
	 * Sets viewport to the dimensions of framebuffer. Called by
	 * {@link #begin()}.
	 */
	 ...
	 *         {@link GL20#glGenRenderbuffer()}). May return 0 even if depth
	 *         buffer enabled
	 */
