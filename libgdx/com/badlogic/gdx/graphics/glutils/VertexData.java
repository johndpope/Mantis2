...
public interface VertexData extends Disposable {
	 ...
	 * count must equal the number of floats per vertex times the number of
	 * vertices to be copied to this VertexData. The order of the vertex
	...
	/**
	 * Returns the underlying FloatBuffer and marks it as dirty, causing the
	 * buffer contents to be uploaded on the next call to bind. If you need
	 * immediate uploading use {@link #setVertices(float[], int, int)}; Any
	 * modifications made to the Buffer *after* the call to bind will not
	...
	/**
	 * Invalidates the VertexData if applicable. Use this in case of a context
	 * loss.
	 */
