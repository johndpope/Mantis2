...
public class GLVersion {
	...
	/**
	 * @return what {@link Type} of GL implementation this application has
	 *         access to, e.g. {@link Type#OpenGL} or {@link Type#GLES}
	 */
	public Type getType() {
		return type;
	}
	...
	/**
	 * @return the major version of current GL connection. -1 if running
	 *         headless
	 */
	...
	/**
	 * @return the name of the renderer associated with the current GL
	 *         connection. This name is typically specific to a particular
	...
	/**
	 * Checks to see if the current GL connection version is higher, or equal to
	 * the provided test versions.
	 *
	 * @param testMajorVersion
	 *            the major version to test against
	 * @param testMinorVersion
	 *            the minor version to test against
	 * @return true if the current version is higher or equal to the test
	 *         version
	 */
