...
public class HdpiUtils {
	/**
	 * Calls {@link GL20#glScissor(int, int, int, int)}, expecting the
	 * coordinates and sizes given in logical coordinates and automatically
	 * converts them to backbuffer coordinates, which may be bigger on HDPI
	 * screens.
	 */
	...
	/**
	 * Calls {@link GL20#glViewport(int, int, int, int)}, expecting the
	 * coordinates and sizes given in logical coordinates and automatically
	 * converts them to backbuffer coordinates, which may be bigger on HDPI
	 * screens.
	 */
	...
	/**
	 * Converts an x-coordinate given in backbuffer coordinates to logical
	 * screen coordinates.
	 */
