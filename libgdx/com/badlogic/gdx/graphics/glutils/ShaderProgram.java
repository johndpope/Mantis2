...
public class ShaderProgram implements Disposable {
	...
	private int linkProgram(int program) {
		...
		if (linked == 0) {
			// Gdx.gl20.glGetProgramiv(program, GL20.GL_INFO_LOG_LENGTH,
			// intbuf);
			// int infoLogLength = intbuf.get(0);
			// if (infoLogLength > 1) {
	 ...
	 *         stage. The shader needs to be bound for this method to have an
	 *         effect.
	 */
	...
	/**
	 * Sets the uniform with the given name. The {@link ShaderProgram} must be
	...
	/**
	 * Sets the uniform matrix with the given name. The {@link ShaderProgram}
	...
	/**
	 * Sets the vertex attribute with the given name. The {@link ShaderProgram}
	 * must be bound for this to work.
	 * 
	 * @param name
	 *            the attribute name
