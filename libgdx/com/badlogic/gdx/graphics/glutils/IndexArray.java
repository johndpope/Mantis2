...
public class IndexArray implements IndexData {
	...
	// used to work around bug:
	// https://android-review.googlesource.com/#/c/73175/
	...
	public IndexArray(int maxIndices) {
		...
		empty = maxIndices == 0;
		if (empty) {
			maxIndices = 1; // avoid allocating a zero-sized buffer because of
							// bug in Android's ART < Android 5.0
		}
	 ...
	 * count must equal the number of indices to be copied to this IndexArray.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * Invalidates the IndexArray so a new OpenGL buffer handle is created. Use
	 * this in case of a context loss.
	 */
