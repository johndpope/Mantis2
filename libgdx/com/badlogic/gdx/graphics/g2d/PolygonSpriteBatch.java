...
public class PolygonSpriteBatch implements Batch {
	...
	/**
	 * Constructs a PolygonSpriteBatch with the default shader, 2000 vertices,
	 * and 4000 triangles.
	 * 
	 ...
	 * 
	 * @param size
	 *            The max number of vertices and number of triangles in a single
	 *            batch. Max of 32767.
	 * @see #PolygonSpriteBatch(int, int, ShaderProgram)
	 */
	 ...
	 * 
	 * @param maxVertices
	 *            The max number of vertices in a single batch. Max of 32767.
	 * @param maxTriangles
	 *            The max number of triangles in a single batch.
	 * @param defaultShader
	 *            The default shader to use. This is not owned by the
	 *            PolygonSpriteBatch and must be disposed separately. May be
	 ...
	 * must be made up of 5 elements in this order: x, y, color, u, v.
	 */
