...
public class Animation<T> {
	...
	/**
	 * Length must not be modified without updating {@link #animationDuration}.
	 * See {@link #setKeyFrames(T[])}.
	 */
	T[] keyFrames;
	 ...
	 * seconds an object has spent in the state this Animation instance
	 * represents, e.g. running, jumping and so on. The mode specifies whether
	 * the animation is looping or not.
	 * 
	 * @param stateTime
