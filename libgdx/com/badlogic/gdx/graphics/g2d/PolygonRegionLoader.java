...
public class PolygonRegionLoader extends SynchronousAssetLoader<PolygonRegion, PolygonRegionParameters> {
	...
	public static class PolygonRegionParameters extends AssetLoaderParameters<PolygonRegion> {
		...
		/**
		 * what the line starts with that contains the file name of the texture
		 * for this {@code PolygonRegion}
		 */
	 ...
	 * {@link AssetDescriptor} for the file referenced on that line will be
	 * added to the returned Array. Otherwise a sibling of the given file with
	 * the same name and the first found extension in
	 * {@link PolygonRegionParameters#textureExtensions
	 * params.textureExtensions} will be used. If no suitable file is found, the
	...
	/**
	 * Loads a PolygonRegion from a PSH (Polygon SHape) file. The PSH file
	 * format defines the polygon vertices before triangulation:
	 * <p>
	 * s 200.0, 100.0, ...
	 * <p>
