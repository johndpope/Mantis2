...
public class NinePatch {
	 ...
	 * patches must be consistently sized (e.g., any left edge textures must
	 * have the same width, etc). Patches may be <code>null</code>. Patch
	 * indices are specified via the public members {@link #TOP_LEFT},
	 * {@link #TOP_CENTER}, etc.
	 */
