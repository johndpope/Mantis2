...
public class SpriteBatch implements Batch {
	/**
	 * @deprecated Do not use, this field is for testing only and is likely to
	 *             be removed. Sets the {@link VertexDataType} to be used when
	 *             gles 3 is not available, defaults to
	 *             {@link VertexDataType#VertexArray}.
	 */
	@Deprecated
	...
	public SpriteBatch(int size, ShaderProgram defaultShader) {
		// 32767 is max vertex index, so 32767 / 4 vertices per sprite = 8191
		// sprites max.
		if (size > 8191)
