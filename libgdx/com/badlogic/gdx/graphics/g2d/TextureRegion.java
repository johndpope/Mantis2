...
public class TextureRegion {
	...
	/**
	 * Constructs a region with the same texture as the specified region and
	 * sets the coordinates relative to the specified region.
	 * 
	 * @param width
	 *            The width of the texture region. May be negative to flip the
	 *            sprite when drawn.
	 ...
	 * @param yAmount
	 *            The percentage to offset vertically. This is done in texture
	...
	/**
	 * Helper function to create tiles out of this TextureRegion starting from
	 * the top left corner going to the right and ending at the bottom right
	 * corner. Only complete tiles will be returned so if the region's width or
	 * height are not a multiple of the tile width and height not all of the
	 * region will be used. This will not work on texture regions returned form
	 * a TextureAtlas that either have whitespace removed or where flipped
	 ...
	 * right corner. Only complete tiles will be returned so if the texture's
	 * width or height are not a multiple of the tile width and height not all
	 * of the texture will be used.
	 * 
	 * @param texture
	 *            the Texture
	 * @param tileWidth
