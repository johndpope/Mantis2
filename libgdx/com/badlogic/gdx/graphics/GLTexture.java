...
public abstract class GLTexture implements Disposable {
	 ...
	 * texture unit specified via {@link GL20#glActiveTexture(int)}.
	 */
	public void bind() {
	 ...
	 *            the v wrap
	 * @param force
	 *            True to always set the values, even if they are the same as
	 *            the current values.
	 */
	...
	/**
	 * Sets the {@link TextureWrap} for this texture on the u and v axis. This
	 * will bind this texture!
	 * 
	 * @param u
	 *            the u wrap
	 * @param v
