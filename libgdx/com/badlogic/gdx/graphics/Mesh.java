...
public class Mesh implements Disposable {
	 ...
	 *            whether vertices of this mesh are static or not. Allows for
	 *            internal optimizations.
	 * @param staticIndices
	 *            whether indices of this mesh are static or not. Allows for
	 *            internal optimizations.
	 * @param maxVertices
	 *            the maximum number of vertices this mesh can hold
	 * @param maxIndices
	...
	/**
	 * Copies the the remaining vertices from the Mesh to the float array. The
	 * float array must be large enough to hold the remaining vertices.
	 * 
	 * @param srcOffset
	 *            the offset (in number of floats) of the vertices in the mesh
	 *            to copy
	 * @param vertices
	 *            the array to copy the vertices to
	 */
	...
	/**
	 * Copies the indices from the Mesh to the short array. The short array must
	 * be large enough to hold destOffset + all the Mesh's indices.
	 * 
	 * @param indices
	 *            the array to copy the indices to
	 * @param destOffset
	 ...
	 * array must be large enough to hold destOffset + all the remaining
	 * indices.
	 * 
	 * @param srcOffset
	...
	/**
	 * Copies the indices from the Mesh to the short array. The short array must
	 * be large enough to hold destOffset + count indices.
	 * 
	 * @param srcOffset
	 *            the zero-based offset of the first index to fetch
	 * @param count
	 ...
	 * functionality. There is a driver bug on the MSM720xa chips that will fuck
	 * up memory if you manipulate the vertices and indices of a Mesh multiple
	...
	/**
	 * Calculates the {@link BoundingBox} of the vertices contained in this
	 * mesh. In case no vertices are defined yet a {@link GdxRuntimeException}
	 ...
	 * This is a potentially slow operation, use with care. It will also create
	 * a temporary float[] which will be garbage collected.
	 * 
	 * @param scaleX
	 *            scale on x
	 * @param scaleY
	...
	/**
	 * Method to transform the positions in the mesh. Normals will be kept as
	 * is. This is a potentially slow operation, use with care. It will also
	 ...
	 * potentially slow operation, use with care. It will also create a
	 ...
	 * 
	 * @param isStatic
	 *            whether the new mesh is static or not. Allows for internal
	 *            optimizations.
	 * @param removeDuplicates
	 *            whether to remove duplicate vertices if possible. Only the
	 *            vertices specified by usage are checked.
	 * @param usage
	...
	public Mesh copy(boolean isStatic, boolean removeDuplicates, final int[] usage) {
		...
		// TODO duplicate the buffers without double copying the data if
		// possible.
