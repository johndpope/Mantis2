...
public interface TextureArrayData {
	...
	/**
	 * Uploads the pixel data of the TextureArray layers of the TextureArray to
	 * the OpenGL ES texture. The caller must bind an OpenGL ES texture. A call
	 * to {@link #prepare()} must preceed a call to this method. Any internal
