...
public interface GL30 extends GL20 {
	...
	// C function void glDrawRangeElements ( GLenum mode, GLuint start, GLuint
	// end, GLsizei count, GLenum type, const GLvoid
	// *indices )

	public void glDrawRangeElements(int mode, int start, int end, int count, int type, java.nio.Buffer indices);

	// C function void glDrawRangeElements ( GLenum mode, GLuint start, GLuint
	// end, GLsizei count, GLenum type, GLsizei offset )
	...
	// C function void glTexSubImage3D ( GLenum target, GLint level, GLint
	// xoffset, GLint yoffset, GLint zoffset, GLsizei width,
	// GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid
	// *pixels )
	...
	// // C function void glCompressedTexImage3D ( GLenum target, GLint level,
	...
	// );
	//
	// // C function void glCompressedTexSubImage3D ( GLenum target, GLint
	...
	// // C function void glGetQueryiv ( GLenum target, GLenum pname, GLint
	// *params )
	//
	...
	// // C function void glGetQueryObjectuiv ( GLuint id, GLenum pname, GLuint
	// *params )
	//
	...
	// C function void glGetBufferPointerv ( GLenum target, GLenum pname,
	// GLvoid** params )
	...
	// C function void glBlitFramebuffer ( GLint srcX0, GLint srcY0, GLint
	// srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint
	...
	// C function void glFramebufferTextureLayer ( GLenum target, GLenum
	// attachment, GLuint texture, GLint level, GLint layer )

	public void glFramebufferTextureLayer(int target, int attachment, int texture, int level, int layer);

	// // C function GLvoid * glMapBufferRange ( GLenum target, GLintptr offset,
	...
	// C function void glFlushMappedBufferRange ( GLenum target, GLintptr
	...
	//
	// // C function void glGetIntegeri_v ( GLenum target, GLuint index, GLint
	// *data )
	//
	...
	// C function void glBindBufferBase ( GLenum target, GLuint index, GLuint
	// buffer )

	public void glBindBufferBase(int target, int index, int buffer);

	// C function void glTransformFeedbackVaryings ( GLuint program, GLsizei
	// count, const GLchar *varyings, GLenum bufferMode )

	public void glTransformFeedbackVaryings(int program, String[] varyings, int bufferMode);

	// // C function void glGetTransformFeedbackVarying ( GLuint program, GLuint
	// index, GLsizei bufSize, GLsizei *length, GLint *size,
	...
	// // C function void glGetVertexAttribIiv ( GLuint index, GLenum pname,
	// GLint *params )
	//
	...
	// // C function void glGetVertexAttribIuiv ( GLuint index, GLenum pname,
	// GLuint *params )
	//
	...
	// C function void glVertexAttribI4i ( GLuint index, GLint x, GLint y, GLint
	// z, GLint w )

	public void glVertexAttribI4i(int index, int x, int y, int z, int w);

	// C function void glVertexAttribI4ui ( GLuint index, GLuint x, GLuint y,
	// GLuint z, GLuint w )
	...
	// );
	//
	// // C function void glGetUniformuiv ( GLuint program, GLint location,
	// GLuint *params )
	//
	...
	// C function GLint glGetFragDataLocation ( GLuint program, const GLchar
	// *name )
	...
	// );
	//
	// // C function void glUniform3ui ( GLint location, GLuint v0, GLuint v1,
	// GLuint v2 )
	//
	...
	// );
	//
	// // C function void glUniform4ui ( GLint location, GLuint v0, GLuint v1,
	// GLuint v2, GLuint v3 )
	//
	...
	// );
	//
	// // C function void glUniform1uiv ( GLint location, GLsizei count, const
	// GLuint *value )
	//
	...
	// // C function void glUniform2uiv ( GLint location, GLsizei count, const
	// GLuint *value )
	//
	...
	// );
	//
	// // C function void glUniform3uiv ( GLint location, GLsizei count, const
	// GLuint *value )
	//
	...
	// // C function void glUniform4uiv ( GLint location, GLsizei count, const
	// GLuint *value )
	//
	...
	// // C function void glClearBufferiv ( GLenum buffer, GLint drawbuffer,
	// const GLint *value )
	//
	...
	// // C function void glClearBufferuiv ( GLenum buffer, GLint drawbuffer,
	// const GLuint *value )
	//
	...
	// // C function void glClearBufferfv ( GLenum buffer, GLint drawbuffer,
	// const GLfloat *value )
	//
	...
	// C function void glClearBufferfi ( GLenum buffer, GLint drawbuffer,
	...
	// C function void glCopyBufferSubData ( GLenum readTarget, GLenum
	// writeTarget, GLintptr readOffset, GLintptr writeOffset,
	// GLsizeiptr size )

	public void glCopyBufferSubData(int readTarget, int writeTarget, int readOffset, int writeOffset, int size);

	// // C function void glGetUniformIndices ( GLuint program, GLsizei
	...
	// // C function void glGetActiveUniformsiv ( GLuint program, GLsizei
	// uniformCount, const GLuint *uniformIndices, GLenum pname,
	// GLint *params )
	//
	...
	// // C function void glDrawElementsInstanced ( GLenum mode, GLsizei count,
	...
	// );
	//
	// // C function GLenum glClientWaitSync ( GLsync sync, GLbitfield flags,
	// GLuint64 timeout )
	//
	...
	// );
	//
	// // C function void glWaitSync ( GLsync sync, GLbitfield flags, GLuint64
	// timeout )
	//
	...
	// // C function void glGetSynciv ( GLsync sync, GLenum pname, GLsizei
	...
	// );
	//
	// // C function void glGetInteger64i_v ( GLenum target, GLuint index,
	// GLint64 *data )
	//
	...
	// );
	//
	// // C function void glGetBufferParameteri64v ( GLenum target, GLenum
	...
	// // C function void glSamplerParameteriv ( GLuint sampler, GLenum pname,
	// const GLint *param )
	//
	...
	// C function void glSamplerParameterf ( GLuint sampler, GLenum pname,
	// GLfloat param )

	public void glSamplerParameterf(int sampler, int pname, float param);

	// // C function void glSamplerParameterfv ( GLuint sampler, GLenum pname,
	// const GLfloat *param )
	//
	...
	// // C function void glGetSamplerParameteriv ( GLuint sampler, GLenum
	// pname, GLint *params )
	//
	...
	// C function void glGetSamplerParameteriv ( GLuint sampler, GLenum pname,
	// GLint *params )
	...
	// // C function void glGetProgramBinary ( GLuint program, GLsizei bufSize,
	...
	// );
	//
	// // C function void glProgramBinary ( GLuint program, GLenum binaryFormat,
	...
	// // C function void glTexStorage2D ( GLenum target, GLsizei levels, GLenum
	...
	// );
	//
	// // C function void glTexStorage3D ( GLenum target, GLsizei levels, GLenum
	// internalformat, GLsizei width, GLsizei height,
	// GLsizei depth )
	//
	...
	// );
	//
	// // C function void glGetInternalformativ ( GLenum target, GLenum
