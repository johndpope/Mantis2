...
public class ShaderProgramLoader
	...
	static public class ShaderProgramParameter extends AssetLoaderParameters<ShaderProgram> {
		/**
		 * File name to be used for the vertex program instead of the default
		 * determined by the file name used to submit this asset to
		 * AssetManager.
		 */
		...
		/**
		 * Code that is always added to the vertex shader code. This is added
		 * as-is, and you should include a newline (`\n`) if needed.
		 * {@linkplain ShaderProgram#prependVertexCode} is placed before this
		 * code.
		 */
		public String prependVertexCode;
		/**
		 * Code that is always added to the fragment shader code. This is added
		 * as-is, and you should include a newline (`\n`) if needed.
		 * {@linkplain ShaderProgram#prependFragmentCode} is placed before this
		 * code.
		 */
