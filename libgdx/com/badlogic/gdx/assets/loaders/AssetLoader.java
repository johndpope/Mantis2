...
public abstract class AssetLoader<T, P extends AssetLoaderParameters<T>> {
	...
	/**
	 * Constructor, sets the {@link FileHandleResolver} to use to resolve the
	 * file associated with the asset name.
	 * 
	 * @param resolver
	 */
	 ...
	 * @return handle to the file, as resolved by the {@link FileHandleResolver}
	 *         set on the loader
	 */
	...
	/**
	 * Returns the assets this asset requires to be loaded first. This method
	 * may be called on a thread other than the GL thread.
	 * 
	 * @param fileName
	 ...
	 * @return other assets that the asset depends on and need to be loaded
	 *         first or null if there are no dependencies.
	 */
