...
public class BitmapFontLoader extends AsynchronousAssetLoader<BitmapFont, BitmapFontLoader.BitmapFontParameter> {
	...
	static public class BitmapFontParameter extends AssetLoaderParameters<BitmapFont> {
		...
		/**
		 * Generates mipmaps for the font if {@code true}. Defaults to
		 * {@code false}.
		 **/
		public boolean genMipMaps = false;

		/**
		 * The {@link TextureFilter} to use when scaling down the
		 * {@link BitmapFont}. Defaults to {@link TextureFilter#Nearest}.
		 */
		public TextureFilter minFilter = TextureFilter.Nearest;

		/**
		 * The {@link TextureFilter} to use when scaling up the
		 * {@link BitmapFont}. Defaults to {@link TextureFilter#Nearest}.
		 */
		...
		/**
		 * The name of the {@link TextureAtlas} to load the {@link BitmapFont}
		 * itself from. Optional; if {@code null}, will look for a separate
		 * image
		 */
