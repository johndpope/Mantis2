...
public class ResolutionFileResolver implements FileHandleResolver {
	...
	public static class Resolution {
		...
		/**
		 * The name of the folder, where the assets which fit this resolution,
		 * are located.
		 */
		 ...
		 * @param folder
		 *            The name of the folder, where the assets which fit this
	 ...
	 * 
	 * @param baseResolver
	 *            The {@link FileHandleResolver} that will ultimately used to
	 *            resolve the file.
	 * @param descriptors
	 *            A list of {@link Resolution}s. At least one has to be
	 *            supplied.
	 */
