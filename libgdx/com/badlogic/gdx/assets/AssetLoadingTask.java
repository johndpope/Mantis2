...
class AssetLoadingTask implements AsyncTask<Void> {
	...
	public Void call() throws Exception {
		...
		if (dependenciesLoaded == false) {
			...
			if (dependencies != null) {
				...
				// if we have no dependencies, we load the async part of the
				// task immediately.
	 ...
	 * method is first called on a worker thread. Once this method returns, the
	 * rest of the asset is loaded on the rendering thread via
