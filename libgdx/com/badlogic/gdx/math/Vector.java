...
public interface Vector<T extends Vector<T>> {
	...
	/**
	 * This method is faster than {@link Vector#len()} because it avoids
	 * calculating a square root. It is useful for comparisons, but not for
	 * getting exact lengths, as the return value is the square of the actual
	 * length.
	 * 
	...
	/**
	 * Sets the length of this vector, based on the square of the desired
	 * length. Does nothing is this vector is zero.
	 * <p />
	 ...
	 * calculating a square root. It is useful for comparisons, but not for
	 * getting accurate distances, as the return value is the square of the
	 * actual distance.
	 * 
	 * @param v
	 *            The other vector
	 ...
	 * (within range [0,1]) using the given Interpolation method. the result is
	 ...
	 *            The interpolation coefficient
	 * @param interpolator
	 *            An Interpolation object describing the used interpolation
	 *            method
	 * @return This vector for chaining.
	 */
	...
	/**
	 * @return Whether this vector is a unit length vector within the given
	 *         margin.
	 */
	...
	/**
	 * @return Whether the length of this vector is smaller than the given
	 *         margin
	 */
	boolean isZero(final float margin);

	/**
	 * @return true if this vector is in line with the other vector (either in
	...
	/**
	 * @return true if this vector is opposite collinear with the other vector
	 *         ({@link #isOnLine(Vector)} &&
	 *         {@link #hasOppositeDirection(Vector)}).
	 */
	boolean isCollinearOpposite(T other);

	/**
	 * @return Whether this vector is perpendicular with the other vector. True
