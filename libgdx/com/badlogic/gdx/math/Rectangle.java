...
public class Rectangle implements Serializable, Shape2D {
	...
	/**
	 * Merges this rectangle with a point. The rectangle should not have
	...
	/**
	 * Merges this rectangle with a list of points. The rectangle should not
	 * have negative width or negative height.
	 * 
	 * @param vecs
	...
	/**
	 * Sets this {@code Rectangle} to the value represented by the specified
