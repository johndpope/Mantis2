...
public class Matrix4 implements Serializable {
	 ...
	 * bottom, right and top specifying the points on the near plane that are
	 * mapped to the lower left and upper right corners of the viewport. This
	 * allows to create projection matrix with off-center vanishing point.
	 * 
	 * @param left
	 * @param right
	 * @param bottom
	 ...
	 *            The other transform
	 * @param w
	 *            Weight of this transform; weight of the other transform is (1
	 *            - w)
	 * @return This matrix for chaining
	 */
	 ...
	 *            the second matrix.
	 */
	public static native void mul(float[] mata,
			float[] matb) /*-{ }-*/; /*
	 ...
	 * to hold a 4x4 column major matrix as you can get from
	 * {@link Matrix4#val}. The vector array is assumed to hold a 3-component
	 * vector, with x being the first element, y being the second and z being
	 * the last component. The result is stored in the vector array. This is the
	 ...
	 *            the vector.
	 */
	public static native void mulVec(float[] mat,
			float[] vec) /*-{ }-*/; /*
	 ...
	 * to hold a 4x4 column major matrix as you can get from
	 * {@link Matrix4#val}. The vectors array is assumed to hold 3-component
	 * vectors. Offset specifies the offset into the array where the x-component
	 * of the first vector is located. The numVecs parameter specifies the
	 * number of vectors stored in the vectors array. The stride parameter
	 * specifies the number of floats between subsequent vectors and must be >=
	 * 3. This is the same as {@link Vector3#mul(Matrix4)} applied to multiple
	 * vectors.
	 * 
	 * @param mat
	 *            the matrix
	 ...
	 *            the vector.
	 */
	public static native void prj(float[] mat,
			float[] vec) /*-{ }-*/; /*
	 ...
	 *            the vector.
	 */
	public static native void rot(float[] mat,
			float[] vec) /*-{ }-*/; /*
									 * matrix4_rot(mat, vec);
									 */
	 ...
	 *         otherwise.
	 */
	public static native boolean inv(
			float[] values) /*-{ }-*/; /*
	 ...
	 */
	public static native float det(
			float[] values) /*-{ }-*/; /*
