...
public class Circle implements Serializable, Shape2D {
	...
	/**
	 * Creates a new {@link Circle} in terms of its center and a point on its
	 * edge.
	 * 
	 * @param center
	...
	/**
	 * Sets this {@link Circle}'s values in terms of its center and a point on
	 * its edge.
	 * 
	 * @param center
	...
	/**
	 * Returns a {@link String} representation of this {@link Circle} of the
	 * form {@code x,y,radius}.
	 */
	@Override
	...
	/**
	 * @return The area of this circle (as {@link MathUtils#PI} * radius *
	 *         radius).
	 */
	public float area() {
