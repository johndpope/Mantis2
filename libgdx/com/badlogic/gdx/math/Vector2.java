...
public class Vector2 implements Serializable, Vector<Vector2> {
	...
	/**
	 * Sets this {@code Vector2} to the value represented by the specified
	...
	/**
	 * @return the angle in radians of this vector (point) relative to the
	 *         x-axis. Angles are towards the positive y-axis. (typically
	 *         counter-clockwise)
	 */
	...
	/**
	 * Rotates the Vector2 by the given angle, counter-clockwise assuming the
	 * y-axis points up.
	 * 
	 * @param degrees
	...
	/**
	 * Rotates the Vector2 by 90 degrees in the specified direction, where >= 0
