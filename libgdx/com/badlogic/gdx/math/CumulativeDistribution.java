...
public class CumulativeDistribution<T> {
	...
	/**
	 * Generate the cumulative distribution in [0,1] where each interval will
	 * get a frequency between [0,1]
	 */
	...
	/**
	 * Finds the value whose interval contains the given probability Binary
	 * search algorithm is used to find the value.
	 * 
	 * @param probability
	...
	/**
	 * Set the interval size on the passed in object. The object must be present
	 * in the distribution.
	 */
