...
public class OpenALAudio implements Audio {
	...
	/**
	 * Retains a list of the most recently played sounds and stops the sound
	 * played least recently if necessary for a new sound to play
	 */
	protected void retain(OpenALSound sound, boolean stop) {
		...
		if (stop) {
			// Stop the least recent sound (the one we are about to bump off the
			// buffer)
