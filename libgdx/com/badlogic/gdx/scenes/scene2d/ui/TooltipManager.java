...
public class TooltipManager {
	 ...
	 * Default is 2. Call {@link #hideAll()} after changing to reset internal
	 * state.
	 */
	...
	/**
	 * The maximum width of a {@link TextTooltip}. The label will wrap if
	 * needed. Default is Integer.MAX_VALUE.
	 */
	public float maxWidth = Integer.MAX_VALUE;
	/**
	 * The distance from the mouse position to offset the tooltip actor. Default
	 * is 15,19.
	 */
	public float offsetX = 15, offsetY = 19;
	/**
	 * The distance from the tooltip actor position to the edge of the screen
	 * where the actor will be shown on the other side of the mouse cursor.
	 * Default is 7.
	 */
	...
	/**
	 * Called when tooltip is shown. Default implementation sets actions to
	 * animate showing.
	 */
	...
	/**
	 * Called when tooltip is hidden. Default implementation sets actions to
	 * animate hiding and to remove the actor from the stage when the actions
	 * are complete. A subclass must at least remove the actor.
	 */
	...
	/**
	 * Shows all tooltips on hover without a delay for {@link #resetTime}
	 * seconds.
	 */
	public void instant() {
		time = 0;
