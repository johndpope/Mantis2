...
public class SelectBox<T> extends Widget implements Disableable {
	...
	/**
	 * Set the max number of items to display when the select box is opened. Set
	 * to 0 (the default) to display as many as fit in the stage height.
	 */
	...
	/**
	 * Set the backing Array that makes up the choices available in the
	 * SelectBox
	 */
	...
	/**
	 * Returns the internal items array. If modified, {@link #setItems(Array)}
