...
public class Cell<T extends Actor> implements Poolable {
	...
	/**
	 * Sets the actor in this cell and adds the actor to the cell's table. If
	 * null, removes any current actor.
	 */
	...
	/**
	 * Sets the spaceTop, spaceLeft, spaceBottom, and spaceRight to the
	 * specified value.
	 */
	...
	/**
	 * Sets the alignment of the actor within the cell. Set to
