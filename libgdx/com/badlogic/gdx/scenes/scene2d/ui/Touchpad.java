...
public class Touchpad extends Widget {
	 ...
	 *            The distance in pixels from the center of the touchpad
	...
	/**
	 * Returns the touchpad's style. Modifying the returned style may not have
	 * an effect until {@link #setStyle(TouchpadStyle)} is called.
	 */
	 ...
	 * touchpad to the edge of the circular movement area. The positive
	 * direction is right.
	 */
