...
public class TextField extends Widget implements Disableable {
	...
	protected void calculateOffsets() {
		...
		// Prevent renderOffset from starting too close to the end, eg after
		// text was deleted.
		float maxOffset = 0;
	...
	/**
	 * If false, methods that change the text will not fire {@link ChangeEvent},
	...
	public class TextFieldClickListener extends ClickListener {
		...
		public boolean keyTyped(InputEvent event, char character) {
			...
			// Disallow "typing" most ASCII control characters, which would show
			// up as a space when onlyFontChars is true.
			switch (character) {
			case BACKSPACE:
			case TAB:
			case ENTER_ANDROID:
