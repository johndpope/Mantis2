...
public class Skin implements Disposable {
	 ...
	 * loaded as a {@link TextureAtlas} and the texture regions added to the
	 * skin. The atlas is automatically disposed when the skin is disposed.
	 */
	...
	/**
	 * Creates a skin containing the resources in the specified skin JSON file
	 * and the texture regions from the specified atlas. The atlas is
	...
	/**
	 * Returns the name to resource mapping for the specified type, or null if
	 ...
	 * exists with the name, a region is created from the texture and stored in
	 * the skin.
	 */
	...
	/**
	 * Returns the name of the specified style object, or null if it is not in
	 * the skin. This compares potentially every style object in the skin of the
	 * same type as the specified style, which may be a somewhat expensive
	 * operation.
	 */
	...
	/**
	 * Returns the {@link TextureAtlas} passed to this skin constructor, or
	 * null.
	 */
		...
		json.setSerializer(BitmapFont.class, new ReadOnlySerializer<BitmapFont>() {
			public BitmapFont read(Json json, JsonValue jsonData, Class type) {
				...
				try {
					...
					// Scaled size is the desired cap height to scale the font
					// to.
					if (scaledSize != -1)
