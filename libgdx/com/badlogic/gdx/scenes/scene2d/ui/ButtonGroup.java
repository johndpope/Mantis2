...
public class ButtonGroup<T extends Button> {
	 ...
	 * changing button checked states should not be done from within this
	 * method.
	 * 
	 ...
	 * maximum is not exceeded. If false, additional buttons beyond the maximum
	 * are not allowed to be checked. Default is true.
	 */
