...
public class Button extends Table implements Disableable {
	...
	/**
	 * Toggles the checked state. This method changes the checked state, which
	 * fires a {@link ChangeEvent} (if programmatic change events are enabled),
	 * so can be used to simulate a button click.
	 */
	public void toggle() {
	...
	/**
	 * When true, the button will not toggle {@link #isChecked()} when clicked
	...
	/**
	 * If false, {@link #setChecked(boolean)} and {@link #toggle()} will not
	 * fire {@link ChangeEvent}, event will be fired only when user clicked the
	 * button
	 */
