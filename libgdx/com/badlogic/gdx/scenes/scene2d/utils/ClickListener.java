...
public class ClickListener extends InputListener {
	...
	/**
	 * Create a listener where {@link #clicked(InputEvent, float, float)} is
	...
	/**
	 * Returns true if the specified position is over the specified actor or
	 * within the tap square.
	 */
	 ...
	 * been very recently. This allows the UI to show a press and release that
	 * was so fast it occurred within a single frame.
	 */
	...
	/**
	 * Returns true if the mouse or touch is over the actor or pressed and
	 * within the tap square.
	 */
