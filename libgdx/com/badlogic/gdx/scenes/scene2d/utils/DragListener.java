...
public class DragListener extends InputListener {
	...
	/*
	 * If a drag is in progress, no further drag methods will be called until a
	 * new drag is started.
	 */
	public void cancel() {
		dragging = false;
	...
	/**
	 * Returns the amount on the x axis that the touch has been dragged since
	 * the last drag event.
	 */
	...
	/**
	 * Returns the amount on the y axis that the touch has been dragged since
	 * the last drag event.
	 */
