...
public class InputListener implements EventListener {
	...
	/**
	 * Called when a mouse button or a finger touch goes down on the actor. If
	 * true is returned, this listener will receive all touchDragged and touchUp
	 * events, even those not over this actor, until touchUp is received. Also
	 ...
	 * if touchDown previously returned true for the mouse button or touch. The
	 * touchUp event is always {@link Event#handle() handled}.
	 * 
	 * @see InputEvent
	 */
	public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
	 ...
	 * only occurs on the desktop. When true is returned, the event is
	...
	/**
	 * Called any time the mouse cursor or a finger touch is moved over an
	 * actor. On the desktop, this event occurs even when no mouse buttons are
	 * pressed (pointer will be -1).
	 * 
	 * @param fromActor
	 *            May be null.
	 * @see InputEvent
	...
	/**
	 * Called any time the mouse cursor or a finger touch is moved out of an
	 * actor. On the desktop, this event occurs even when no mouse buttons are
	 * pressed (pointer will be -1).
	 * 
	 * @param toActor
