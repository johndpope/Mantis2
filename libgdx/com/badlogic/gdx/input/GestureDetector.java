...
public class GestureDetector extends InputAdapter {
	 ...
	 * zooming. Each method returns a boolean indicating if the event should be
	 * handed to the next listener (false to hand it to the next listener, true
	 * otherwise).
	 * 
	 * @author mzechner
	 */
	public static interface GestureListener {
		 ...
		 * The tap square is a rectangular area around the initial touch
		 * position as specified on construction time of the
