...
public class AnimatedTiledMapTile implements TiledMapTile {
	 ...
	 * animation and avoids having to call TimeUtils.millis() in
	 * getTextureRegion()
	 */
	...
	/**
	 * Creates an animated tile with the given animation interval and frame
	 * tiles.
	 * 
	 * @param interval
	 *            The interval between each individual frame tile.
	 * @param frameTiles
	 *            An array of {@link StaticTiledMapTile}s that make up the
	 *            animation.
	 */
	...
	/**
	 * Creates an animated tile with the given animation intervals and frame
	 * tiles.
	 *
	 * @param intervals
	 *            The intervals between each individual frame tile in
	 *            milliseconds.
	 * @param frameTiles
	 *            An array of {@link StaticTiledMapTile}s that make up the
	 *            animation.
