...
public class TiledMapTileSets implements Iterable<TiledMapTileSet> {
	...
	/**
	 * @param tileset
	 *            set to be added to the collection
	 */
	...
	public TiledMapTile getTile(int id) {
		// The purpose of backward iteration here is to maintain backwards
		// compatibility
		// with maps created with earlier versions of a shared tileset. The
		// assumption
		// is that the tilesets are in order of ascending firstgid, and by
		// backward
		// iterating precedence for conflicts is given to later tilesets in the
		// list,
