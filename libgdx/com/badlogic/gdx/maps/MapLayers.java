...
public class MapLayers implements Iterable<MapLayer> {
	...
	/**
	 * @param name
	 * @return the first layer having the specified name, if one exists,
	 *         otherwise null
	 */
	...
	/**
	 * Get the index of the layer having the specified name, or -1 if no such
	 * layer exists.
	 */
	...
	/**
	 * Get the index of the layer in the collection, or -1 if no such layer
	 * exists.
	 */
